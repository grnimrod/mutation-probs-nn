...
#SBATCH --output=/faststorage/project/MutationAnalysis/Nimrod/results/logs/combined_mut_rate/%j_output.log
#SBATCH --error=/faststorage/project/MutationAnalysis/Nimrod/results/logs/combined_mut_rate/%j_error.log
