...
def train_combined(data_version):
    ...
    print("Training on average mutation rate")
    ...
    for bin_size in bin_sizes:
        ...
        X_local_train, X_avg_mut_1mb_train, y_train, X_local_val, X_avg_mut_1mb_val, y_val = load_splits(data_version, requested_splits=["train", "val"], bin_size=bin_size, requested_features=["avg_mut"])
        ...
        model_dir = f"/faststorage/project/MutationAnalysis/Nimrod/results/models/combined/{data_version}/avgmut"
        os.makedirs(model_dir, exist_ok=True)
        torch.save(model.state_dict(), f"{model_dir}/model_{bin_size}.pth")

        plots_dir = f"/faststorage/project/MutationAnalysis/Nimrod/results/figures/combined/{data_version}/avgmut"
